...
class GLRenderer implements GLSurfaceView.Renderer {
   ...
   public void onSurfaceCreated(GL10 gl, EGLConfig config) {
      ...
      float lightAmbient[] = new float[] { 0.4f, 0.4f, 0.4f, 1 };
      ...
      // Optional: disable to boost performance
     ...
     // if (SEE_THRU) {
      ...
      GLCube.loadTexture(gl, context, R.drawable.tree);
   ...
   public void onDrawFrame(GL10 gl) {
      ...
      gl.glRotatef(elapsed * (55f / 1000f), 1, 0, 0);
